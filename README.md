...
| `evidence/` | **The audit layer, in full**: briefs verbatim, all 15 declarations, both adjudications with quoted verdicts, costs, deviation logs, the method with its pre-registration hash chain, and Study 3's pre-registration — registered here, unrun |
